        ...
        <div className="flex flex-col md:flex-row items-center">
          <div className="md:w-1/2 mb-10 md:mb-0">
            <div className="space-y-6">
              ...
              >
                Bring <span className="text-primary-light font-playfair">Nature's{" "}
                Beauty</span> Home
              </motion.h1>
          ...
          <div className="md:w-1/2 relative">
            <div className="relative h-[400px] md:h-[500px] w-full">
              ...
              <motion.img
                ...
                className="absolute top-[25%] left-[30%] transform -translate-x-1/2 -translate-y-1/2 w-64 h-64 object-cover rounded-full shadow-2xl border-4 border-white z-30"
                initial={{ opacity: 0, scale: 0.5, rotate: -10 }}
                animate={{
                  opacity: isLoaded ? 1 : 0,
                  scale: isLoaded ? 1 : 0.5,
